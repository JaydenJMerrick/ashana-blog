document.getElementById('blogForm').addEventListener('submit', async (e) => {
  ...
  const GITHUB_TOKEN = "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"; 
  const REPO_OWNER = "JaydenJMerrick";
  const REPO_NAME = "ashana-blog";
